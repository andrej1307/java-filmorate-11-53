...
public class FilmDbStorage implements FilmStorage {
     ...
     *
     * @param jdbc - объект работы с базой данных
     * @param filmMapper - объект преобразования строк базы данных в объекты класса Film
     */
    public FilmDbStorage(NamedParameterJdbcTemplate jdbc, FilmRowMapper filmMapper,
            ...
            Film film = jdbc.query(SQL_FIND_FILM_BY_ID,
                    ...
                    new ResultSetExtractor<Film>() {
                        ...
                        public Film extractData(ResultSet rs) throws SQLException, DataAccessException {
                            rs.next();
                            Film filmRs = filmMapper.mapRow(rs, 1);
